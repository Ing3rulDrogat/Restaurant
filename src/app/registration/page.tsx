...
function LogIn() {
  ...
  return (
    <div className="w-screen h-screen content-center justify-items-center bg-gradient-to-t from-black from-5% to-gray-600">
      <Header></Header>
      <div className="w-1/5  h-2/3 bg-white/55 flex flex-col items-center rounded-3xl shadow-lg shadow-cyan-700/10 ">
        ...
        {animation !== "animate-BarRight" ? (
          <div className="w-2/3 h-2/3 my-10">
            ...
            <div className="flex flex-col items-center">
              ...
              <button
                onClick={function2}
                className="flex items-center bg-amber-500 text-black px-4 py-2 rounded hover:bg-cyan-600"
              >
          ...
          <div className="w-2/3 h-2/3 my-10">
            ...
            <div className="flex flex-col items-center">
              ...
              <button
                ...
                className="flex items-center bg-amber-500 text-black px-2 py-2 rounded hover:bg-cyan-600"
              >
